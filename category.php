<?php get_header(); ?>
        ...
        <div id="container">
            <div id="content">
				...
				<<h1 class="page-title"><?php _e( 'Category Archives:', 'colorburst' ) ?> <span><?php single_cat_title() ?></span></span></h1>
                	...
                	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    	...
                    	<div class="entry-utility">
                        	<?php if ( $cats_meow = cats_meow(', ') ) : // Returns categories other than the one queried ?>
              			    	<span class="cat-links"><?php printf( __( 'Also posted in %s', 'colorburst' ), $cats_meow ) ?></span>
                        		<span class="meta-sep"> | </span>
							<?php endif ?>
                        	<span class="meta-sep"> | </span>
